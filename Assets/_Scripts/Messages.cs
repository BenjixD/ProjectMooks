public class Messages {
    ...
    public static string OnTurnStart = "OnTurnStart"; //void
    
    public static string OnPartySetup = "OnPartySetup"; // void

    public static string OnMoveSelection = "OnMoveSelection"; // void
